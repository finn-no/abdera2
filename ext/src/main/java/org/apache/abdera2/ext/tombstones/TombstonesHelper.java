 ...
 */
package org.apache.abdera2.ext.tombstones;
...
public class TombstonesHelper {
    ...
    public static Iterable<Tombstone> getTombstones(Feed source) {
    ...
    public static Tombstone addTombstone(Feed source, Entry entry, DateTime when, String by, String comment) {
        Tombstone ts = addTombstone(source, entry);
        ts.setWhen(when);
        ts.setBy(by);
        ts.setComment(comment);
    ...
    public static Tombstone addTombstone(Feed source, String id, DateTime when, String by, String comment) {
        Tombstone ts = addTombstone(source, id);
        ts.setWhen(when);
        ts.setBy(by);
        ts.setComment(comment);
