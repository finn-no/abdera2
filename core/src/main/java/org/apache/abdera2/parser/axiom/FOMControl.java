...
public class FOMControl extends FOMExtensibleElement implements Control {
    ...
    public FOMControl(String name, OMNamespace namespace, OMContainer parent, OMFactory factory) throws OMException {
    ...
    public FOMControl(QName qname, OMContainer parent, OMFactory factory, OMXMLParserWrapper builder) {
        super(qname, parent, factory, builder);
    }

    public FOMControl(OMContainer parent, OMFactory factory, OMXMLParserWrapper builder) throws OMException {
        super(CONTROL, parent, factory, builder);
    }

    public FOMControl(OMContainer parent, OMFactory factory) throws OMException {
