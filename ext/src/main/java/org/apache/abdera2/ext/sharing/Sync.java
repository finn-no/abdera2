...
@QName(value="sync",ns=SharingHelper.SSENS,pfx=SharingHelper.SSEPFX)
public class Sync extends ExtensibleElementWrapper {
    ...
    public Sync(Factory factory, javax.xml.namespace.QName qname) {
        super(factory, qname);
    }
